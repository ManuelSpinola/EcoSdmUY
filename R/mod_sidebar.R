...
mod_sidebar_ui <- function(id) {
  ...
  tagList(
    ...
    div(
      ...
      # Escudo de Uruguay (SVG inline simple como placeholder)
      div(
        style = "font-size: 2.8rem; line-height: 1;",
        "\U0001F1FA\U0001F1FE"   # emoji bandera Uruguay
      ),
      p(class = "small text-muted mt-1 mb-0", "República Oriental del Uruguay")
    ),
    ...
    div(
      ...
      p(class = "fw-bold mb-0",
        style = "color:#0038A8; font-size:0.95rem; line-height:1.3;",
    ...
    output$estado_modelo <- renderUI({
      if (!is.null(estado$prediccion_sf)) {
        ...
        div(
          ...
          "No se encontraron registros para esta especie en Uruguay."
        )
      }
    })
